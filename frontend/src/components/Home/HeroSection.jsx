  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-white text-center md:text-left max-w-xl space-y-4">
        ...
        <p className="text-base sm:text-lg md:text-[18px] text-white">
        ...
        <Link href="/booking" aria-label="Book a wedding photography session">
          <button
            className="mt-4 px-6 py-3 bg-gradient-to-r from-pink-600 to-rose-500 hover:bg-pink-600 text-white font-semibold rounded-full transition-transform hover:scale-105 duration-200 min-w-[44px] min-h-[44px] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-pink-300 focus-visible:ring-offset-2 cursor-pointer"
