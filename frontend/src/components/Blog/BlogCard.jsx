    ...
    <Link href={`/blogs/${blog.slug}`} passHref>
      <motion.div
        className="
          ...
          transition-all duration-500 hover:shadow-xl border border-gray-100 cursor-pointer
      ...
      >
        ...
        <div className="relative h-40 w-full overflow-hidden sm:h-44 md:h-48">
          ...
          {/* Category Badge */}
          {blog.category && (
            <span className="absolute bottom-2 left-2 rounded-full bg-indigo-600 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-white shadow-md">
              {blog.category}
            </span>
          )}
        </div>
        ...
        <div className="flex flex-col justify-between p-3 sm:p-4 flex-1">
          <div>
            <h3 className="mb-2 text-base sm:text-lg font-semibold leading-snug text-gray-900 transition-colors duration-300 group-hover:text-indigo-600 line-clamp-2">
              {blog.title}
            </h3>
          ...
          {/* Meta Info */}
          <div className="mt-3 flex items-center justify-between text-[11px] sm:text-xs text-gray-500 border-t border-gray-100 pt-2">
            ...
            <span className="text-indigo-600 font-medium hover:text-indigo-800 transition-colors flex items-center gap-1">
              Read More
              <svg
                xmlns="http://www.w3.org/2000/svg"
