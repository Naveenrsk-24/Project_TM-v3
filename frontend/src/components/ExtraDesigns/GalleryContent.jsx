  ...
  const galleryItems = [
    {
      ...
      description: "We capture the real moments between the planned ones. Every couple has a unique rhythm, and we blend seamlessly into your day to document genuine emotions.",
      imagePosition: "left"
    },
    {
      image: "/Weddings/Rajasekar-Nithya/Rajasekar-Nithya-102.jpg",
      title: "Cinematic Storytelling",
      description: "Inspired by western editorial styles, our photography feels like film stills brought to life. We focus on natural light and candid expressions.",
      imagePosition: "right"
    },
    {
      image: "/Weddings/Arul-Vijayalakshmi/Arul-Vijayalakshmi-109.jpg",
      title: "Timeless Elegance",
      description: "Your wedding images should feel as beautiful decades from now as they do today. We create photographs that transcend trends.",
      imagePosition: "left"
    },
    {
      image: "/Weddings/Arul-Vijayalakshmi/Arul-Vijayalakshmi-103.jpg",
      title: "Internationally Recognized",
      description: "Our work has been featured in leading wedding publications and recognized by international photography communities.",
      imagePosition: "right"
    }
  ];
  ...
  return (
    <section className="relative bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900 py-16 px-6 lg:px-12 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-[12%] right-[10%] w-[28rem] h-[28rem] bg-pink-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
      </div>
      ...
      <div className="relative max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-purple-600/30 to-pink-600/30 backdrop-blur-md border border-purple-400/40 shadow-lg shadow-purple-500/20 mb-4">
            ...
            <span className="text-xs font-black text-white tracking-[0.2em] uppercase">Our Approach</span>
          </div>
        ...
        <div className="space-y-12">
          {galleryItems.map((item, idx) => (
            <div
              ...
              style={{
                animation: `slideUp 0.7s cubic-bezier(0.16, 1, 0.3, 1) ${idx * 0.15}s both`
              }}
            >
              <style jsx>{`
                @keyframes slideUp {
              ...
              >
                ...
                <div
                  className={`absolute w-full h-full border-3 ${
                    idx % 2 === 0 ? "border-purple-500/30" : "border-pink-500/30"
                  } ${
                    item.imagePosition === "left"
                      ? "top-3 left-3"
                      : "bottom-3 right-3"
                  } transition-all duration-500 group-hover:${
                    idx % 2 === 0 ? "border-purple-400/50" : "border-pink-400/50"
                  }`}
                />

                {/* Glow effect on hover */}
                <div className={`absolute -inset-0.5 rounded-sm bg-gradient-to-r ${
                  idx % 2 === 0
              ...
              <div
                className={`space-y-3 ${
                  item.imagePosition === "right" ? "lg:col-start-1 lg:row-start-1" : ""
                }`}
              >
                <h3 className={`text-2xl lg:text-3xl font-black transition-all duration-300 ${
                  idx % 2 === 0
