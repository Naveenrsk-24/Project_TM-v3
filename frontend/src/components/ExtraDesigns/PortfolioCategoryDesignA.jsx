...
// The single image URL provided by the user for all categories
...
const categories = [
  {
    ...
    image: USER_IMAGE_URL, // Updated to use the user's single URL
    count: '50+ Sessions',
...
const PhotographyCategories = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-100">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        ...
        <div className="mt-20 text-center">
          <div className="inline-flex flex-col items-center gap-6">
            ...
            <button className="px-10 py-4 border-2 border-neutral-300 hover:border-amber-500 text-neutral-700 hover:text-amber-600 rounded-full font-semibold transition-all duration-300 hover:shadow-xl">
      ...
      {/* Floating Elements */}
      <div className="fixed top-1/4 right-10 w-20 h-20 bg-amber-200/20 rounded-full blur-2xl pointer-events-none animate-pulse"></div>
      <div className="fixed bottom-1/4 left-10 w-24 h-24 bg-rose-200/20 rounded-full blur-2xl pointer-events-none animate-pulse" style={{ animationDelay: '1.5s' }}></div>
    </div>
  );
};
