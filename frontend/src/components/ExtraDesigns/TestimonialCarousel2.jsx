    ...
    <div className="relative min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-100 py-20 px-4 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          <button
            onClick={handlePrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-6 w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gradient-to-r hover:from-amber-600 hover:to-amber-500 hover:text-white transition-all duration-300 group"
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="relative w-20 h-20 rounded-full overflow-hidden ring-4 ring-white shadow-lg">
                ...
                />
                {activeIndex === index && (
                  <div className="absolute inset-0 bg-gradient-to-t from-amber-600/40 to-transparent"></div>
                )}
              </div>
            </button>
          ))}
