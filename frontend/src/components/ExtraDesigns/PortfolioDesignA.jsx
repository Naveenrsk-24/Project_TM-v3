...
const portfolioImages = [
  ...
  { id: 14, src: USER_IMAGE_URL, alt: 'Traditional ceremony', span: 'row-span-2' },
  { id: 15, src: USER_IMAGE_URL, alt: 'Scenic backdrop', span: 'row-span-1' },
  { id: 16, src: USER_IMAGE_URL, alt: 'Beach romance', span: 'row-span-2' },
  { id: 17, src: USER_IMAGE_URL, alt: 'Rice field setting', span: 'row-span-2' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-100">
      ...
      <div className="relative overflow-hidden pt-20 pb-12 px-4">
        ...
        <div className={`max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-6 py-2 rounded-full shadow-sm mb-6">
            <Camera className="w-4 h-4 text-amber-600" />
            <span className="text-sm font-medium text-neutral-700">Our Portfolio</span>
          </div>
      ...
      <div className="fixed bottom-20 right-10 w-40 h-40 bg-rose-200/20 rounded-full blur-3xl pointer-events-none animate-pulse" style={{ animationDelay: '1s' }}></div>
    </div>
  );
};
