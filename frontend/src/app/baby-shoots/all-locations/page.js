...
export const metadata = {
  title: "All Baby Shoot Locations | TM Studios",
  description: "Explore all baby photography locations across major cities and localities.",
};

export default function BabyShootAllLocations() {
  const service = SERVICES["baby-shoots"];
            ...
            <div key={city.slug}>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                {city.localities.map((area) => (
                  <Link
                    key={area.slug}
                    href={`/baby-shoots/${city.slug}/${area.slug}`}
