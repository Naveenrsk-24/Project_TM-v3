export const SERVICES = {
 weddings: {
  ...
  "baby-shoots": {
    ...
    bgImage: "/BabyShoots/BabyshootBanner.avif",
    ...
    niches: [
      {
        ...
        description: "0-14 days old babies",
      },
      {
        slug: "milestone",
        title: "Milestone Shoots",
        description: "3, 6, 9 month sessions",
      },
      {
        slug: "cake-smash",
        title: "Cake Smash",
    ...
    niches: [
      {
        ...
        description: "Beach and garden shoots",
      },
      {
        slug: "studio",
        title: "Studio Maternity",
        description: "Classic indoor portraits",
      },
      {
        slug: "creative",
        title: "Creative Maternity",
        description: "Artistic concepts",
      },
    ],
    popular: false,
  },
    ...
    localities: [
      {
        slug: "ecr",
        name: "ECR",
        description: "Beach-side photography locations",
      },
      { slug: "omr", name: "OMR", description: "IT corridor photography" },
      {
        slug: "t-nagar",
        name: "T. Nagar",
        description: "Central Chennai photography",
      },
      {
        slug: "adyar",
        name: "Adyar",
        description: "Premium photography services",
      },
      {
        slug: "velachery",
        name: "Velachery",
        description: "South Chennai photography",
      },
      {
        slug: "anna-nagar",
        name: "Anna Nagar",
        description: "West Chennai photography",
      },
    ],
  },
